# Bot to play the Shogi game.
# Made with minimax algorithm
# Author : Pranay Venkatesh (SupremeFiend)

# Pretty much normal Shogi, but there is no resurrections or promotions.
# TODO:
#       Implement check and checkmate conditions
#       BAN JUMPING OVER OTHER PIECES
                            ...
                            for s2 in r2:
                                if s2.clicked and s2 is not s:
                                    ...
                                    if s2.player is not None:
                                        if s2.player.side == 'BLACK' and black_turn:
